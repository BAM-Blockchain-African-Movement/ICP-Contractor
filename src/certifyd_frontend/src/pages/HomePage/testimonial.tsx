...
export const Testimonial = (props: Testimonial27Props) => {
    ...
    <section className="overflow-hidden px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          <h2 className="mb-5 text-4xl font-bold text-blue-900 md:mb-6 md:text-6xl lg:text-7xl">{heading}</h2>
          <p className="md:text-md text-blue-950 text-xl">{description}</p>
        </div>
          ...
          <div className="mt-[30px] flex items-center justify-center md:mt-[46px]">
            {testimonials.map((_, index) => (
              <button
                ...
                className={clsx("relative mx-[3px] border border-blue-800 inline-block size-2 rounded-full", {
                  "bg-blue-800": current === index + 1,
...
const TestimonialCard = ({ testimonial }: { testimonial: Testimonial }) => {
  return (
    <div className="flex w-full flex-col items-start justify-between border border-blue-600 rounded-2xl p-6 md:p-8">
